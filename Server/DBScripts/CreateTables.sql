USE [WIT]
GO
/****** Object:  StoredProcedure [dbo].[spCreateDummyData]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[__MigrationHistory]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetRoles]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserClaims]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserLogins]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserRoles]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUsers]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Wit_Category]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Wit_Company]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Wit_Item]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Wit_NavBar]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Wit_NavBarRoles]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Wit_NavBarRoles](
	[RoleId] [nvarchar](128) NOT NULL,
	[NavBar_UID] [uniqueidentifier] NOT NULL,
 CONSTRAINT [PK_Wit_NavBarRoles] PRIMARY KEY CLUSTERED 
(
	[RoleId] ASC,
	[NavBar_UID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Wit_Order]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Wit_Order](
 ...
 CONSTRAINT [PK__Wit_Orde__6EC573CF43187D67] PRIMARY KEY CLUSTERED 
(
	[Order_UID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Wit_Session]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Wit_Session](
	...
	[ModifiedDate] [datetime] NULL,
	[ModifiedBy] [nvarchar](50) NULL,
 CONSTRAINT [PK_Wit_Session] PRIMARY KEY CLUSTERED 
(
	[Session_UID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Wit_Table]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Wit_Transaction]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Wit_Transaction](
	...
	[ModifiedDate] [datetime] NULL,
	[ModifiedBy] [nvarchar](50) NULL,
 CONSTRAINT [PK__Wit_Tran__7E82B44053117C68] PRIMARY KEY CLUSTERED 
(
	[Transaction_UID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Wit_User]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[UsersViewModel]    Script Date: 11/24/2014 5:39:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Wit_Order] ADD  CONSTRAINT [DF__Wit_Order__Order__3A81B327]  DEFAULT (newsequentialid()) FOR [Order_UID]
GO
ALTER TABLE [dbo].[Wit_Order] ADD  CONSTRAINT [DF_Wit_Order_ModifiedDate]  DEFAULT (getdate()) FOR [ModifiedDate]
GO
ALTER TABLE [dbo].[Wit_Session] ADD  CONSTRAINT [DF_Wit_Session_Session_UID]  DEFAULT (newsequentialid()) FOR [Session_UID]
GO
ALTER TABLE [dbo].[Wit_Session] ADD  CONSTRAINT [DF_Wit_Session_ModifiedDate]  DEFAULT (getdate()) FOR [ModifiedDate]
GO
...
GO
ALTER TABLE [dbo].[Wit_Transaction] ADD  CONSTRAINT [DF__Wit_Trans__Trans__412EB0B6]  DEFAULT (newsequentialid()) FOR [Transaction_UID]
GO
...
GO
ALTER TABLE [dbo].[Wit_NavBarRoles]  WITH CHECK ADD  CONSTRAINT [FK_Wit_NavBarRoles_AspNetRoles] FOREIGN KEY([RoleId])
REFERENCES [dbo].[AspNetRoles] ([Id])
GO
ALTER TABLE [dbo].[Wit_NavBarRoles] CHECK CONSTRAINT [FK_Wit_NavBarRoles_AspNetRoles]
GO
ALTER TABLE [dbo].[Wit_NavBarRoles]  WITH CHECK ADD  CONSTRAINT [FK_Wit_NavBarRoles_Wit_NavBar] FOREIGN KEY([NavBar_UID])
REFERENCES [dbo].[Wit_NavBar] ([NavBar_UID])
GO
ALTER TABLE [dbo].[Wit_NavBarRoles] CHECK CONSTRAINT [FK_Wit_NavBarRoles_Wit_NavBar]
GO
...
GO
ALTER TABLE [dbo].[Wit_Session]  WITH CHECK ADD  CONSTRAINT [FK_Wit_Session_Wit_User] FOREIGN KEY([User_UID])
REFERENCES [dbo].[Wit_User] ([User_UID])
GO
ALTER TABLE [dbo].[Wit_Session] CHECK CONSTRAINT [FK_Wit_Session_Wit_User]
GO
